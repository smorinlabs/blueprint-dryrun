...
[![PyPI version](https://img.shields.io/pypi/v/blueprint-dryrun.svg)](https://pypi.org/project/blueprint-dryrun/)
[![Python versions](https://img.shields.io/pypi/pyversions/blueprint-dryrun.svg)](https://pypi.org/project/blueprint-dryrun/)
[![CI](https://github.com/smorinlabs/blueprint-dryrun/actions/workflows/ci.yml/badge.svg)](https://github.com/smorinlabs/blueprint-dryrun/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/smorinlabs/blueprint-dryrun/branch/main/graph/badge.svg)](https://codecov.io/gh/smorinlabs/blueprint-dryrun)
...
![Py Launch Blueprint Logo](./assets/images/logos/blueprint_dryrun_logo_100x100.png)
...
Install as a tool: `uvx --from blueprint-dryrun bpd` (uvx needs `--from` because the distribution name differs from the console-script name) or `pip install blueprint-dryrun && bpd`.
