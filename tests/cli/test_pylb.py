...
from blueprint_dryrun.cli.context import AppContext, maybe_show_first_run_hint
from blueprint_dryrun.cli.main import cli
from blueprint_dryrun.cli.output import OutputMode, Renderer
from blueprint_dryrun.core.config import Config
from blueprint_dryrun.core.models import Project
...
@pytest.fixture
def mock_service():
    with patch("blueprint_dryrun.cli.commands.projects.ProjectsService") as mock_cls:
        svc = Mock()
...
def test_color_precedence_resolution(monkeypatch):
    from blueprint_dryrun.cli.context import _resolve_color
...
def test_console_level_precedence():
    ...
    from blueprint_dryrun.cli.context import _resolve_console_level
