...
from blueprint_dryrun.core.errors import APIError
from blueprint_dryrun.core.models import Project
from blueprint_dryrun.web.app import create_app
from blueprint_dryrun.web.deps import get_projects_service
...
def test_readyz_failure_is_a_problem_with_diagnostics(client, monkeypatch):
    from blueprint_dryrun.core.models import DoctorCheck, DoctorReport
    from blueprint_dryrun.web import app as app_module
