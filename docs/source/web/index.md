...
in [design 0002](https://github.com/smorinlabs/blueprint-dryrun/blob/main/docs/design/0002-web-api-conventions.md)
and [ADR 0013](https://github.com/smorinlabs/blueprint-dryrun/blob/main/docs/adr/0013-web-service-best-practices.md).
For the root-level walkthrough (the web counterpart of EXAMPLECLI.md) see
[EXAMPLEWEB.md](https://github.com/smorinlabs/blueprint-dryrun/blob/main/EXAMPLEWEB.md).
...
python -m blueprint_dryrun.web # production-shaped runner
...
Everything is an env var with the `BPD_WEB_` prefix (derived from the app
