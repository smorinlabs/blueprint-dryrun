...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/smorinlabs/blueprint-dryrun",
            "html": """
...
html_logo = "_static/blueprint_dryrun_logo_100x100.png"
