...
Status: accepted. Scope: `src/blueprint_dryrun/web/` — the FastAPI service
...
(dev reload) or `python -m blueprint_dryrun.web` (production-shaped).
...
- **WEB-31 — graceful shutdown**: `python -m blueprint_dryrun.web` and the
